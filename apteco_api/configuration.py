...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of apteco_api.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the apteco_api.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = apteco_api.Configuration(
        signing_info = apteco_api.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://example.com/OrbitAPI",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("apteco_api")

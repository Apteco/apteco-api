...
import apteco_api
from apteco_api.models.calculate_dashboard_data import CalculateDashboardData  # noqa: E501
from apteco_api.rest import ApiException

class TestCalculateDashboardData(unittest.TestCase):
    """CalculateDashboardData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CalculateDashboardData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = apteco_api.models.calculate_dashboard_data.CalculateDashboardData()  # noqa: E501
        if include_optional :
            return CalculateDashboardData(
                global_filter_applied = apteco_api.models.query.Query(
                    selection = apteco_api.models.selection.Selection(
                        ...
                        name = '0', ), 
                    today_at = '0', ), 
                dashboard_items_to_calculate = [
                    apteco_api.models.calculate_dashboard_item.CalculateDashboardItem(
                        dashboard_item_id = '0', 
                        drill_down_level = 56, 
                        dimension_filter = apteco_api.models.query.Query(
                            selection = apteco_api.models.selection.Selection(
                                ancestor_counts = True, 
                                record_set = apteco_api.models.record_set.RecordSet(
                                    type = 'URN', 
    ...
    def testCalculateDashboardData(self):
        """Test CalculateDashboardData"""

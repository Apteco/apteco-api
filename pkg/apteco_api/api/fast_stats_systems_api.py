...
class FastStatsSystemsApi(object):
    ...
    def fast_stats_systems_get_all_fast_stats_system_items(self, data_view_name, system_name, **kwargs):  # noqa: E501
        ...
        :param str filter: Filter the list of items using a simple expression language.  The available list of fields are Key, Type, TableName, VariableType. The following functions can also be used in the filter: GetAncestorsDescendantsAndSelf('tablename'), GetAncestorsAndSelf('tablename'), GetAncestors('tablename').
    ...
    def fast_stats_systems_get_fast_stats_folder(self, data_view_name, system_name, path, **kwargs):  # noqa: E501
        ...
        :param str filter: Filter the list of items using a simple expression language.  The available list of fields are Name, Description, Type, TableName, VariableType. The following functions can also be used in the filter: GetAncestorsDescendantsAndSelf('tablename'), GetAncestorsAndSelf('tablename'), GetAncestors('tablename').
    ...
    def fast_stats_systems_get_fast_stats_tables(self, data_view_name, system_name, **kwargs):  # noqa: E501
        ...
        :param str data_view_name: The name of the DataView to act on (required)
        :param str system_name: The name of the FastStats system to act on (required)
        :param str filter: Filter the list of items using a simple expression language.  The available list of fields are Name, SingularDisplayName, PluralDisplayName, TotalRecords. The following functions can also be used in the filter: GetAncestorsDescendantsAndSelf('tablename'), GetAncestorsAndSelf('tablename'), GetAncestors('tablename').
    ...
    def fast_stats_systems_get_fast_stats_variable_with_http_info(self, data_view_name, system_name, variable_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('variable_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['variable_name'] is None):  # noqa: E501
    ...
    def fast_stats_systems_get_fast_stats_variables(self, data_view_name, system_name, **kwargs):  # noqa: E501
        ...
        :param str data_view_name: The name of the DataView to act on (required)
        :param str system_name: The name of the FastStats system to act on (required)
        :param str filter: Filter the list of items using a simple expression language.  The available list of fields are Name, Description, Type, SelectorType, TableName, NumberOfCodes, FolderName. The following functions can also be used in the filter: GetAncestorsDescendantsAndSelf('tablename'), GetAncestorsAndSelf('tablename'), GetAncestors('tablename').
    ...
    def fast_stats_systems_refresh_fast_stats_variable_codes_sync(self, data_view_name, system_name, variable_name, **kwargs):  # noqa: E501
        """Gets all the categories (var codes) for the specified variable in the FastStats system if it is a selector variable  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fast_stats_systems_refresh_fast_stats_variable_codes_sync(data_view_name, system_name, variable_name, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fast_stats_systems_refresh_fast_stats_variable_codes_sync_with_http_info(data_view_name, system_name, variable_name, **kwargs)  # noqa: E501

    def fast_stats_systems_refresh_fast_stats_variable_codes_sync_with_http_info(self, data_view_name, system_name, variable_name, **kwargs):  # noqa: E501
        """Gets all the categories (var codes) for the specified variable in the FastStats system if it is a selector variable  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fast_stats_systems_refresh_fast_stats_variable_codes_sync_with_http_info(data_view_name, system_name, variable_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method fast_stats_systems_refresh_fast_stats_variable_codes_sync" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'data_view_name' is set
        if self.api_client.client_side_validation and ('data_view_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['data_view_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `data_view_name` when calling `fast_stats_systems_refresh_fast_stats_variable_codes_sync`")  # noqa: E501
        # verify the required parameter 'system_name' is set
        if self.api_client.client_side_validation and ('system_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['system_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `system_name` when calling `fast_stats_systems_refresh_fast_stats_variable_codes_sync`")  # noqa: E501
        # verify the required parameter 'variable_name' is set
        if self.api_client.client_side_validation and ('variable_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['variable_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `variable_name` when calling `fast_stats_systems_refresh_fast_stats_variable_codes_sync`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/{dataViewName}/FastStatsSystems/{systemName}/Variables/{variableName}/Codes', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
